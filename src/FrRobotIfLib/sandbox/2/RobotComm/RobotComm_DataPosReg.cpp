...
DataPosReg::DataPosReg() {
    m_pDispatch = NULL;
}

DataPosReg::DataPosReg(LPDISPATCH pDispatch) {
    m_pDispatch = NULL;
...
void DataPosReg::Initialize(LPDISPATCH pDispatch) {
    if(m_pDispatch) {
        m_pDispatch->Release();
        m_pDispatch = NULL;
    }
...
LPDISPATCH DataPosReg::GetDataTable() {
    if (!m_pDispatch) {
        return NULL;
    }
...
BOOL DataPosReg::GetValueXyzwpr(long Index, float* X, float* Y, float* Z, float* W, float* P, float* R, float* E1, float* E2, float* E3, short* C1, short* C2, short* C3, short* C4, short* C5, short* C6, short* C7, short* UF, short* UT, short* validc) {
    if (!m_pDispatch) {
        return FALSE;
    }
    ...
    VariantClear(&args[19]);
    VariantClear(&vResult);
    return result;
}

BOOL DataPosReg::GetValueJoint(long Index, float* J1, float* J2, float* J3, float* J4, float* J5, float* J6, float* J7, float* J8, float* J9, short* UT, short* ValidJ) {
    if (!m_pDispatch) {
        return FALSE;
    }
...
BOOL DataPosReg::SetValueJoint2(long Index, float J1, float J2, float J3, float J4, float J5, float J6, float J7, float J8, float J9, short UF, short UT) {
    if (!m_pDispatch) {
        return FALSE;
    }
...
BOOL DataPosReg::SetValueXyzwpr2(long Index, float X, float Y, float Z, float W, float P, float R, float E1, float E2, float E3, short C1, short C2, short C3, short C4, short C5, short C6, short C7, short UF, short UT) {
    if (!m_pDispatch) {
        return FALSE;
    }
...
CString DataPosReg::GetTypeName() {
    if (!m_pDispatch) {
        return _T("");
    }
...
void DataPosReg::AddUserMessage(LPCTSTR vstrMessage) {
    if (!m_pDispatch) {
        return;
    }
    ...
    m_pDispatch->Invoke(0x60030019, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &dp, NULL, &excepInfo, &argerr);

    VariantClear(&args[0]);
}

BOOL DataPosReg::GetDebugLog() {
    if (!m_pDispatch) {
        return FALSE;
    }
    ...
    VariantInit(&vResult);
    HRESULT hr = m_pDispatch->Invoke(0x6803001a, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_PROPERTYGET, &dp, &vResult, &excepInfo, &argerr);
