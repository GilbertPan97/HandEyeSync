...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "C:/SFR_SDK/boost_1_78_0/include/boost-1_78")
  endif()
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "C:/SFR_SDK/Eigen3/include/eigen3" ABSOLUTE)
  endif()
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    set(FLANN_ROOT "C:/SFR_SDK/flann-1.9.1")
  endif()
...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/cmake/vtk-9.2" CACHE PATH "The directory containing VTKConfig.cmake")
    else()
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/vtk-9.2" CACHE PATH "The directory containing VTKConfig.cmake")
    endif()
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "C:/SFR_SDK/VTK-9.2.5/lib/cmake/vtk-9.2" CACHE PATH "The directory containing VTKConfig.cmake")
  endif()
  if(NOT ANDROID)
...
list(APPEND PCL_DEFINITIONS  -D__SSE4_2__ -D__SSE4_1__ -D__SSSE3__ -D__SSE3__ -D__SSE2__ -D__SSE__)
